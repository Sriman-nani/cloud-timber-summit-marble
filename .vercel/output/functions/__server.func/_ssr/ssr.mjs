...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DvAX2Vw5.mjs");
...
var manifest = { "40a7b6ccdc9a16182bf9bcfb0181e4808a1567378372e9121ac348c4f1d73ea6": {
	functionName: "analyzeScene_createServerFn_handler",
	importer: () => import("./analyze-Bxyv29Qr.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BUw-wPaj.mjs").then((n) => n.t),
